...
const initialRows = [
  ...
  createData(7, 'Tarefa 7', 'Descrição da Tarefa 7', '2022-01-01', '2022-01-02', 'Concluída', 'Recurso 7'),
  createData(8, 'Tarefa 8', 'Descrição da Tarefa 8', '2022-01-03', '2022-01-04', 'Em Andamento', 'Recurso 8'),
  createData(9, 'Tarefa 9', 'Descrição da Tarefa 9', '2022-01-04', '2022-01-05', 'Em Andamento', 'Recurso 9'),
  createData(10, 'Tarefa 10', 'Descrição da Tarefa 10', '2022-01-05', '2022-01-06', 'Em Andamento', 'Recurso 10'),
  createData(11, 'Tarefa 11', 'Descrição da Tarefa 11', '2022-01-06', '2022-01-07', 'Em Andamento', 'Recurso 11'),
  createData(12, 'Tarefa 12', 'Descrição da Tarefa 12', '2022-01-07', '2022-01-08', 'Aguardando', 'Recurso 12'),
];
    ...
    setTarefas(current =>
      current.filter(tarefa => {
        if(tarefa.idTarefa === id) {
          alert(`${tarefa.descricaoTarefa} removida com sucesso!`)
        }
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right">Data Finalização</TableCell>
